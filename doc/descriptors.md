# Support for Output Descriptors in vegancoin Core

Since vegancoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `vg1...` for mainnet or `tvg1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on vegancoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing vegancoin Core wallets, a convenience function `combo` is
